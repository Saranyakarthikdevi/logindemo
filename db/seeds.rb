...
Product.create!(title: 'Ruby Performance Optimization',
  description:
    %{<p>
      ...
      You donâ€™t have to accept slow Ruby or Rails performance. In this
      comprehensive guide to Ruby optimization, youâ€™ll learn how to write
      faster Ruby codeâ€”but thatâ€™s just the beginning. See exactly what makes
      ...
      performance testing, garbage collection, and tuning. Youâ€™ll find that
      all those â€œhardâ€ things arenâ€™t so difficult after all, and your code
